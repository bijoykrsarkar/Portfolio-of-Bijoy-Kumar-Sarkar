document.addEventListener('DOMContentLoaded', () => {
    ...
    /* ========================================================
       ...
       Pure CSS — the fill-in animation is handled entirely by the
       @keyframes rule in style.css, no JS or external chart library
       needed (removed the Chart.js/CDN dependency that was silently
       failing to render on some mobile connections).
       ======================================================== */
